...
void BinaryDataFile::WriteToFile(sls_receiver_header *header, char *buffer,
    ...
    if (sizeof(sls_bitset) == sizeof(bitset_storage)) {
        ret += fwrite(header, 1, sizeof(sls_receiver_header), fd_);
    ...
    // not contiguous bitset
        ...
        ret = fwrite(detHeader, 1, sizeof(sls_detector_header), fd_);
